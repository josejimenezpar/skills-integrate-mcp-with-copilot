...
from src.models import init_db, SessionLocal, Activity, Participant

def seed_database():
    """Populate database with initial activities"""
    # Initialize database
    init_db()
    ...
    # Commit all changes
    db.commit()
    print(f"Database seeded with {len(activities_data)} activities")
    db.close()
